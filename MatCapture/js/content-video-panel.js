...
(async function () {
    ...
    let nsc_content_video_panel = {
        ...
        html: async function () {
            ...
            const element = !!document.fullscreenElement ? document.fullscreenElement : document.body;

            $(element).append(html).append($('<div>').addClass('nsc-video-editor').addClass('nsc-hide'));
