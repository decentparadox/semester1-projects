...
class nscNimbusConnect {
        ...
        try {
            ...
            if (data.reason === 'devicequota') {
                ...
                if(!this.user.premium) {
                    premium = (nscExt.getOption('defOrganizationType') === "business");
                } else {
                    premium = true;
                }
            }
    ...
    async getInfo() {
        ...
        if (errorCode === 0) {
            ...
            this.user.premium = premium ? premium.active : false;
    ...
    async viewOrganizations() {
        ...
        nscExt.setOption('defOrganizationType', defOrganization.type);

        if(defOrganization.type === "business") {
            $("#nsc_tom_menu_link_enterprise").attr('href', 'https://teams.nimbusweb.me/?utm_source=capture&utm_medium=addon&utm_campaign=edit_page&menu=capture')
                .text('Manage members')
        } else {
            $("#nsc_tom_menu_link_enterprise").attr('href', 'https://nimbusweb.me/enterprise?utm_source=capture&utm_medium=addon&utm_campaign=edit_page&menu=capture')
